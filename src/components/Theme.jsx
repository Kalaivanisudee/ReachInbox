...
const containerStyle = (currColor) => ({
    width: '32px',
    height: '32px',
    border: '2px solid',
    borderColor: currColor ? 'white' : 'black',
    borderRadius: '50%',
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: currColor ? '#a0e0a0' : '#000',
    cursor: 'pointer',
});
...
const Theme = ({ currColor, onClick }) => {
    return (
        <div style={containerStyle(currColor)} onClick={onClick}>
            {!currColor ?
                ...
                :
                <svg strokeWidth="0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style={svgStyle}>
